    ...
    <section id="service-offers">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p>At <strong>Feminize Digital</strong>, we provide a wide range of mobile app development services to make your business stand out in the competitive market. From ideas to creation we provide end-to-end solutions to create a seamless high-performing applications.
                </p>
            </div>
            <div class="row">
                <div class="col-md-6">
