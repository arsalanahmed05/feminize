<?php 
$pageTitle = "Video Editing | Feminize Digitals"; // 
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="text-wrapper">
                        <h1>Video <br><ruby>Editing</ruby></h1>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="img-bg">
                        <img src="/assets/images/services-images/video-editing-banner-img.webp" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
