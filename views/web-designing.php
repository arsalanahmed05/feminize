<?php 
$pageTitle = "Web Designing | Feminize Digitals"; // 
include_once("includes/head.php"); 
?>
<?php include_once("includes/header.php") ?>


<body id="web-desigining">
    <div id="cursor">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="text-wrapper">
                        <h1>Web <br><ruby>Designing</ruby></h1>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="img-bg">
